...
export const INITIAL_AI_RULES: Rule[] = [
    ...
    { id: 'ai_19', text: "Bối cảnh Địa Lý: Mọi sự kiện xảy ra PHẢI diễn ra tại địa điểm hiện tại của người chơi (`geographicalContext`). Hãy dùng mô tả của Đại Vực, Châu Lục, và Khu Vực để tạo ra các sự kiện và tường thuật phù hợp. Việc di chuyển đến một Khu Vực khác là một hành động quan trọng và PHẢI được phản ánh trong `newLocationId`." }
];
